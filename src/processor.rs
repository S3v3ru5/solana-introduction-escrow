use solana_program::{
    ...
    msg,
    pubkey::Pubkey,
    program_pack::{Pack, IsIntialized},
...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        let intializer = next_account_info(account_info_iter)?;
        ...
        if escrow_info.is_initialized() {
            return Err(ProgramError::AccountAlreadyIntialized);
        }

        escrow_info.is_initialized = true;
        escrow_info.initializer_pubkey = *initalizer.key;
    ...
    fn process_exchange(
        ...
        if amount_expected_by_taker != pdas_temp_token_account_info.amount {
            return Err(Escrow::ExpectedAmountMismatch.into());
        }
        ...
        msg!("Calling the token program to transfer to the escrow's initializer ...");
        invoke(
